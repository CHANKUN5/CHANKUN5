...
<h3 align="center">
  ...
  &nbsp;Hola, soy Kassandra Nayeli Castro Huauya
</h3>
...
- 🎓 Estudiando **Desarrollo de Software** en **SENATI** (penúltimo ciclo)
- 💼 Practicante Frontend en **APM Inversiones E.I.R.L.** — React · Next.js · APIs REST
- 🎨 Me apasiona el **diseño de interfaces UI/UX** — creo que el frontend no solo debe funcionar, debe emocionar
- 🌱 Actualmente profundizando en **TypeScript** y **arquitecturas escalables con Next.js**
- 🌍 Inglés **B2 – Intermediate** (British English)
- 📍 Lima, Perú
- 💬 Pregúntame sobre **React, Next.js, Tailwind CSS o diseño frontend**
- 📫 Escríbeme a: **kasschankasskun@gmail.com**
...
|----------|-------------|-------|------|
| 🏢 **Sistema RV4** | Arquitectura feature-driven con Server Components y rutas API | Next.js · TypeScript · Tailwind | [🔗 Ver](https://github.com/rp-software1/RP-SOFT-Rv4-SALA-FN/tree/feature-castro/Next) |
| 📸 **ArteIdeas** | Plataforma completa para estudio fotográfico con dashboard en tiempo real | React · Vite · React Router | [🔗 Ver](https://github.com/CHANKUN5/ArteIdeas) |
| 📝 **Blogger** | App de blog con autenticación, paginación y validación avanzada con Zod | React · Axios · React Hook Form | [🔗 Ver](https://github.com/CHANKUN5/Blogger) |
| 📊 **APM – KPIs** | Dashboard empresarial para visualización de indicadores clave | React · JavaScript · Tailwind | [🔗 Ver](https://github.com/CHANKUN5/APM) |
| 🏥 **Marketing Médico** | Landing responsiva para agencia de marketing del sector salud | React · Bootstrap | [🔗 Ver](https://github.com/CHANKUN5/MarketingMedico) |
